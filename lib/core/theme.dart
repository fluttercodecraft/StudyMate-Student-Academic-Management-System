...
class AppColors {
  // Brand Colors
  static const Color primary = Color(0xFF196EEE); // StudyMate signature blue
  static const Color primaryDark = Color(0xFF0F4CB8);
...
class AppShadows {
  ...
  static List<BoxShadow> medium = [
    BoxShadow(
      color: const Color(0xFF196EEE).withOpacity(0.12),
      blurRadius: 16,
